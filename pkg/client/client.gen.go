...
type ClientInterface interface {
	...
	UpdateContainerWithBody(ctx context.Context, containerId ContainerIdPath, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateContainerWithApplicationMergePatchPlusJSONBody(ctx context.Context, containerId ContainerIdPath, body UpdateContainerApplicationMergePatchPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) UpdateContainerWithBody(ctx context.Context, containerId ContainerIdPath, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) UpdateContainerWithApplicationMergePatchPlusJSONBody(ctx context.Context, containerId ContainerIdPath, body UpdateContainerApplicationMergePatchPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateContainerRequestWithApplicationMergePatchPlusJSONBody(c.Server, containerId, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewUpdateContainerRequestWithApplicationMergePatchPlusJSONBody calls the generic UpdateContainer builder with application/merge-patch+json body
func NewUpdateContainerRequestWithApplicationMergePatchPlusJSONBody(server string, containerId ContainerIdPath, body UpdateContainerApplicationMergePatchPlusJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateContainerRequestWithBody(server, containerId, "application/merge-patch+json", bodyReader)
}

// NewUpdateContainerRequestWithBody generates requests for UpdateContainer with any type of body
func NewUpdateContainerRequestWithBody(server string, containerId ContainerIdPath, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	UpdateContainerWithBodyWithResponse(ctx context.Context, containerId ContainerIdPath, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateContainerResponse, error)

	UpdateContainerWithApplicationMergePatchPlusJSONBodyWithResponse(ctx context.Context, containerId ContainerIdPath, body UpdateContainerApplicationMergePatchPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateContainerResponse, error)
}
...
func (c *ClientWithResponses) UpdateContainerWithBodyWithResponse(ctx context.Context, containerId ContainerIdPath, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateContainerResponse, error) {
...
func (c *ClientWithResponses) UpdateContainerWithApplicationMergePatchPlusJSONBodyWithResponse(ctx context.Context, containerId ContainerIdPath, body UpdateContainerApplicationMergePatchPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateContainerResponse, error) {
	rsp, err := c.UpdateContainerWithApplicationMergePatchPlusJSONBody(ctx, containerId, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateContainerResponse(rsp)
