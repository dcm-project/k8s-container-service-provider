...
type Container struct {
	...
	// Etag Opaque version identifier for optimistic concurrency (AEP-154). Derived from the underlying Kubernetes resource version.
	...
	// Uid System-assigned immutable unique identifier (AEP-148). Derived from the underlying Kubernetes resource UID.
...
type ListContainersParams struct {
	...
	// Filter AEP-132 filter expression (accepted but not yet implemented)
	Filter *string `form:"filter,omitempty" json:"filter,omitempty"`

	// OrderBy AEP-132 ordering expression (accepted but not yet implemented)
...
type UpdateContainerApplicationMergePatchPlusJSONRequestBody = Container
